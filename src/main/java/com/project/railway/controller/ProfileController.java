...
public class ProfileController {
    ...
    public String getProfileInfoPage(Model model){
        ...
        model.addAttribute("active_link", "information");
    ...
    public String getProfileAddressPage(Model model){
        Client client = (Client) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        model.addAttribute("active_link", "address");
        model.addAttribute("client", client);
        return "address";
    }
    ...
    public String getProfileDiscountPage(Model model){
        ...
        Client client = (Client) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        model.addAttribute("active_link", "discount");
    ...
    public String getProfileHistoryPage(Model model){
        ...
        List<Ticket> cancelledTickets = ticketRepository.findTicketByClientIdAndTicketStatus(client.getId(), ticketStatusRepository.findTicketStatusByStatus("cancelled"));
        List<Ticket> validatedTickets = ticketRepository.findTicketByClientIdAndTicketStatus(client.getId(), ticketStatusRepository.findTicketStatusByStatus("validated"));
        expiredTickets.addAll(cancelledTickets);
        expiredTickets.addAll(validatedTickets);
        Collections.sort(expiredTickets);
        model.addAttribute("active_link", "history");
    ...
    public String getProfilePaymentPage(Model model){
        ...
        model.addAttribute("active_link", "payment");
        model.addAttribute("client", client);
        return "creditcard";
    }
