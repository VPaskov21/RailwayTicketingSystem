...
public class BookingController {
    ...
    public String postBookingSpaceStep(@ModelAttribute("bookingData") BookingData bookingData,
        ...
        if(clientService.validateClientData(bookingData.getClient().getFirstName(),
                                            bookingData.getClient().getLastName(),
                                            bookingData.getClient().getEmail(),
                                            bookingData.getClient().getPhoneNumber(),
                                            bookingData.getClient().getDiscountType().getId(),
                                            bookingData.getClient().getDocumentNumber())){
            model.addAttribute("client", SecurityContextHolder.getContext().getAuthentication().getPrincipal());
            return "/booking/space";
        }else{
            model.addAttribute("client", SecurityContextHolder.getContext().getAuthentication().getPrincipal());
