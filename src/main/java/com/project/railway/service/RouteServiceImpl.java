    ...
    public List<RouteList> findRoutesBetweenStations(final String departureStation, final String arrivalStation, String departureDate) {
        ...
        for (int i = 0; i < routeEnd.size(); i++) {
            for (int j = 0; j < routes.size(); j++) {
                if (routeEnd.get(i).getTrain().getId().equals(routes.get(j).getTrain().getId()) && routeEnd.get(i).getId() >= routes.get(j).getRouteStart()) {
        ...
        for(int i=0;i<routes.size();i++){
            System.out.println("TrainID: " + routes.get(i).getTrain().getId() +
                                " RouteStart: " + routes.get(i).getRouteStart() +
                                " RouteEnd: " + routes.get(i).getRouteEnd());
        }
            ...
            if (routes.get(i).getRouteStart() != null && routes.get(i).getRouteEnd() != null) {
                ...
                if(i==0){
                    if ((routes.get(i).getRouteEnd() - routes.get(i).getRouteStart()) > 2 && (routes.get(i).getRouteEnd() - routes.get(i).getRouteStart() < 7)) {
                        ...
                        double price = Math.round(routes.get(i).getPrice()*100.0)/100.0;
                        routes.get(i).setPrice(price);
                    }
                }if(i>0){
                ...
                routes.get(i).setPriceString(Double.toString((Math.round(routes.get(i).getPrice()*100.0)/100.0)));

                routes.get(i).setFirstClassPrice(Math.round((routes.get(i).getPrice() + (routes.get(i).getPrice()*(25.0/100.0)))*100.0)/100.0);

                routes.get(i).setFirstClassPriceString(Double.toString(Math.round(routes.get(i).getFirstClassPrice()*100.0)/100.0));
                ...
                if (Long.toString(diffMinutes).equals("0")) {
                    ...
                    travelTimeMins = "0" + Long.toString(diffMinutes);
                } else {
